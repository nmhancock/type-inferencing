...
make_ctx(struct lang_type *types, int max_types)
{
...
struct lang_type *
Err(struct inferencing_ctx *ctx, enum lang_type_type err,
    char *symbol)
{
...
struct lang_type *
Function(struct inferencing_ctx *ctx, struct lang_type *arg_t,
